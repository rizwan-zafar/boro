    ...
    >
      ...
      >
        <div className="text-center">
          <h2
            className={cn(
              'text-3xl md:text-4xl font-manrope font-extrabold leading-snug md:leading-tight xl:leading-[1.3em] mb-3 md:mb-4 xl:mb-3 -mt-2 xl:-mt-3 2xl:-mt-4 text ',
              {
                'text-brand xl:text-5xl 2xl:text-[55px]':
                  variant === 'default',
                'text-brand xl:text-[40px] 2xl:text-5xl 2xl:mb-4 2xl:pb-0.5':
                  variant === 'medium',
